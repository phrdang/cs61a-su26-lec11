...
# uv run pytest --doctest-modules --cov=count_vowel_occurrences_sol --cov-report=html count_vowel_occurrences_sol.py
...
def count_vowel_occurrences(text: str, vowel: str) -> int:
    ...
    2
    >>> count_vowel_occurrences("banana", "a")
    3

    -- Edge Case: Case Insensitivity (Both text and vowel) --
    >>> count_vowel_occurrences("Ice Cream", "i")
    1
    >>> count_vowel_occurrences("Apples are awesome", "A")
    3

    -- Edge Case: Empty String --
    >>> count_vowel_occurrences("", "e")
    0
    ...
    >>> count_vowel_occurrences("crypt", "u")
    0

    -- Edge Case: Invalid Input for 'vowel' (Multi-character or Non-vowel) --
    >>> count_vowel_occurrences("hello", "ou")
    Traceback (most recent call last):
        ...
    ValueError: Vowel must be a single character.
    >>> count_vowel_occurrences("hello", "x")
    Traceback (most recent call last):
        ...
    ValueError: 'x' is not a valid vowel.
    """
